...
q_APD = np.genfromtxt('C:/Users/Пользователь/Desktop/Лаба/калибровки/Продолжение работы по калибровки аналоговых детекторов/Взаимные калибровки/Меньше шаг по мощности/m1.2t31s900O.txt', 'float64')
q_PMT = np.genfromtxt('C:/Users/Пользователь/Desktop/Лаба/калибровки/Продолжение работы по калибровки аналоговых детекторов/Взаимные калибровки/Меньше шаг по мощности/m1.2t31s900F.txt', 'float64')
for k in range(1300, 2000, 25):
    ...
    with open('C:/Users/Пользователь/Desktop/3.txt', "w+") as file:
        ...
        my_file1 = "C:/Users/Пользователь/Desktop/Лаба/калибровки/Продолжение работы по калибровки аналоговых детекторов/Взаимные калибровки/Меньше шаг по мощности/m1.2t31s900O.txt"
    ...
    # green
    X = delete_noize_new(my_file1, 1943, 99999, 0, 0, 0, 0, 'new_file1.txt')
    # orange
